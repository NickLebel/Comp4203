...
//flow monitor for PDR / packet loss / delay
#include "ns3/flow-monitor-module.h"

//---------------- CHANGE FILE NAME ----------------
//global file name, for both CSV and XML
std::string FILE_NAME ("S3-OLSR-50node-10ms");
...
RoutingExperiment::RoutingExperiment ()
  : port (9),
    bytesTotal (0),
    packetsReceived (0),
    m_CSVfileName (FILE_NAME+".csv"),
    m_traceMobility (false),
    //---------------- CHANGE PROTOCOL ----------------
    m_protocol (1)   //OLSR = 1 | AODV = 2 | DSDV = 3
{
}
...
RoutingExperiment::Run (int nSinks, double txp, std::string CSVfileName)
{
  ...
  std::string tr_name = FILE_NAME;
  //---------------- CHANGE SPEED OF NODES ----------------
  ...
  //write info for PDR + packet loss + delay for each receiver to XML
